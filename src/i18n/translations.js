...
export const T = {
  en: {
    ...
    chat: {
      ...
      assistantAvatar: "🥧",
      quickPrompts: [
        "Who is Mustafa? (short)",
        "What tech does Mustafa focus on? (bullet list)",
        "If you don't know something about Mustafa, what do you do?",
        "Summarize this project (ask me for context if needed).",
      ],
  ...
  de: {
    ...
    chat: {
      ...
      assistantAvatar: "🥧",
      quickPrompts: [
        "Wer ist Mustafa? (kurz)",
        "Worauf ist Mustafa technisch fokussiert? (Stichpunkte)",
        "Wenn du etwas über Mustafa nicht weißt: was machst du dann?",
        "Fasse dieses Projekt zusammen (frage nach Kontext, falls nötig).",
      ],
  ...
  ar: {
    ...
    chat: {
      ...
      quickPrompts: [
        "مين مصطفى؟ (باختصار)",
        "شو المجالات التقنية اللي بيركز عليها مصطفى؟ (نقاط)",
        "إذا ما بتعرف معلومة عن مصطفى، شو بتعمل؟",
        "لخّص هذا المشروع (واسألني عن السياق إذا لزم).",
      ],
  ...
  tr: {
    ...
    chat: {
      ...
      quickPrompts: [
        "Mustafa kim? (kısa)",
        "Mustafa hangi teknik alanlara odaklanıyor? (madde madde)",
        "Mustafa hakkında bilmediğin bir şey sorulursa ne yaparsın?",
        "Bu projeyi özetle (gerekirse benden bağlam iste).",
      ],
