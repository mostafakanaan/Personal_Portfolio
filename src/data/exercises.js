      ...
      sections: [
        {
          ...
          questions: [
            { id: "a2-lv-11-1", question: "Wie hei\u00dft das Albino-K\u00e4nguru?", options: ["Leo", "Max", "Tom", "Benny"], correct: 1, points: 6 },
            { id: "a2-lv-11-2", question: "Was k\u00f6nnen die Kinder im Zoo machen?", options: ["Essen kaufen", "Tiere f\u00fcttern", "Spielen", "Schlafen"], correct: 1, points: 6 },
            { id: "a2-lv-11-3", question: "Wo leben die Tiere im Zoo?", options: ["In kleinen K\u00e4figen", "In gro\u00dfen Gehegen", "In einem Haus", "Auf der Stra\u00dfe"], correct: 1, points: 6 },
            { id: "a2-lv-11-4", question: "Wann findet die F\u00fctterung der Tiere statt?", options: ["Jeden Tag", "Jeden Sonntag", "Jeden Montag", "Jeden Freitag"], correct: 1, points: 6 },
            { id: "a2-lv-11-5", question: "Was gibt es im Zoo neben den Tieren?", options: ["Ein Restaurant", "Ein Kino", "Einen Park mit Blumen", "Ein Schwimmbad"], correct: 2, points: 6 },
          ],
        },
        {
          id: "grammatik",
          ...
          text: null,
          questions: [
            { id: "a2-gr-11-1", question: "Was ist die richtige Form? \"Ich ____ ins Kino.\" ", options: ["geht", "gehe", "gehst", "geh"], correct: 1, points: 8 },
            { id: "a2-gr-11-2", question: "Was ist korrekt? \"Er ___ ein Buch.\" ", options: ["lesen", "liest", "liest du", "liest er"], correct: 1, points: 8 },
            { id: "a2-gr-11-3", question: "Was ist die richtige Antwort? \"Wo ___ du?\" ", options: ["bin", "ist", "bist", "sehe"], correct: 2, points: 8 },
            { id: "a2-gr-11-4", question: "Vervollst\u00e4ndige den Satz: \"Wir haben einen Hund, ___ ist sehr s\u00fc\u00df.\" ", options: ["der", "die", "das", "und"], correct: 0, points: 8 },
            { id: "a2-gr-11-5", question: "Was sagt man in der Vergangenheit? \"Ich ___ ein Buch lesen.\" ", options: ["lese", "gelesen", "las", "lesen"], correct: 2, points: 8 },
          ],
        },
        {
          id: "hoerverstehen",
          ...
          text: null,
          questions: [
            { id: "a2-hv-11-1", question: "Welche Tiere werden zuerst gezeigt?", options: ["Giraffen", "Ziegen", "K\u00e4ngurus", "Schweine"], correct: 1, points: 6 },
            { id: "a2-hv-11-2", question: "Welches Essen m\u00f6gen die Giraffen?", options: ["Brot", "Fleisch", "Salat und \u00c4pfel", "Pizza"], correct: 2, points: 6 },
      ...
      sections: [
        {
          ...
          questions: [
            { id: "a2-lv-12-1", question: "Was kann man im Park riechen?", options: ["A) Tiere", "B) Pflanzen und Blumen", "C) Essen", "D) Parfum"], correct: 1, points: 6 },
            ...
            { id: "a2-lv-12-3", question: "Wann ist der Park besonders sch\u00f6n?", options: ["A) Im Winter", "B) Im Herbst", "C) Im Sommer", "D) Im Fr\u00fchling"], correct: 3, points: 6 },
            { id: "a2-lv-12-4", question: "Warum kommen viele Menschen in den Park?", options: ["A) Um zu arbeiten", "B) Um sich zu entspannen", "C) Um zu essen", "D) Um Sport zu machen"], correct: 1, points: 6 },
            { id: "a2-lv-12-5", question: "Was gibt es im Park?", options: ["A) Eiskunstlauf", "B) Pflanzen und Blumen", "C) Sportger\u00e4te", "D) Tiere"], correct: 1, points: 6 },
          ],
        },
        {
          id: "grammatik",
          ...
          text: null,
          questions: [
            { id: "a2-gr-12-1", question: "Welches Wort ist richtig? 'Ich _____ im Park.'", options: ["A) sein", "B) bin", "C) bist", "D) seid"], correct: 1, points: 8 },
            { id: "a2-gr-12-2", question: "Welche Form ist richtig? 'Sie _____ einen sch\u00f6nen Tag.'", options: ["A) haben", "B) hat", "C) habe", "D) habt"], correct: 0, points: 8 },
            { id: "a2-gr-12-3", question: "Was sagt man? 'Ich _____ in die Stadt gehen.'", options: ["A) will", "B) willst", "C) wollen", "D) wollt"], correct: 0, points: 8 },
            { id: "a2-gr-12-4", question: "Wie lautet die korrekte Frage? '_____ du gern schwimmen?'", options: ["A) Mag", "B) Magst", "C) M\u00f6gen", "D) M\u00f6gt"], correct: 1, points: 8 },
            { id: "a2-gr-12-5", question: "Welches Wort passt nicht? 'Das ist ein _____ Park.'", options: ["A) sch\u00f6n", "B) sch\u00f6ne", "C) sch\u00f6nes", "D) sch\u00f6ner"], correct: 0, points: 8 },
          ],
        },
        {
          id: "hoerverstehen",
          title: "Hörverstehen",
          audioSrc: "/audio/aufgabe12/a2.mp3",
          text: null,
          questions: [
            { id: "a2-hv-12-1", question: "Was ist wichtig f\u00fcr uns alle?", options: ["A) Die Umwelt", "B) Das Geld", "C) Die Technologie", "D) Die Autos"], correct: 0, points: 6 },
            { id: "a2-hv-12-2", question: "Was k\u00f6nnen wir benutzen, um die Umwelt zu sch\u00fctzen?", options: ["A) Mehr Plastik", "B) Weniger Plastik"], correct: 1, points: 6 },
            { id: "a2-hv-12-3", question: "F\u00e4hrt jeder mehr Fahrrad?", options: ["Wahr", "Falsch"], correct: 1, points: 6 },
            { id: "a2-hv-12-4", question: "Was hilft der Natur?", options: ["A) Mehr Autofahren", "B) Weniger Wasser trinken", "C) Mehr Fahrrad fahren", "D) Mehr M\u00fcll produzieren"], correct: 2, points: 6 },
            { id: "a2-hv-12-5", question: "Die Welt wird sch\u00f6ner, wenn jeder mitmacht. (Wahr/Falsch)?", options: ["Wahr", "Falsch"], correct: 0, points: 6 },
          ],
        },
      ],
      maxPoints: 100,
      ...
      sections: [
        {
          ...
          questions: [
            { id: "b1-lv-11-1", question: "Was sind die Hauptmerkmale nachhaltiger Mode?", options: ["Umweltfreundlich und sozial verantwortlich", "Teuer und unpraktisch", "Modisch und schnelllebig", "Einzigartig und schwer zu finden"], correct: 0, points: 6 },
            { id: "b1-lv-11-2", question: "Warum entscheiden sich viele Verbraucher f\u00fcr Second-Hand-Kleidung?", options: ["Weil sie neu und teuer ist", "Um zur Abfallreduzierung beizutragen", "Weil es keine anderen Optionen gibt", "Um den neuesten Trends zu folgen"], correct: 1, points: 6 },
            { id: "b1-lv-11-3", question: "Was ist ein Problem der Modeindustrie?", options: ["Hohe Qualit\u00e4t der Kleidung", "Faire Arbeitsbedingungen", "Umweltverschmutzung", "Geringe Nachfrage nach Kleidung"], correct: 2, points: 6 },
            { id: "b1-lv-11-4", question: "Was k\u00f6nnten Designer in der Zukunft tun?", options: ["Nur traditionelle Kleidung herstellen", "Innovative Ideen entwickeln", "Nur recycelte Materialien verwenden", "Kleidung schneller produzieren"], correct: 1, points: 6 },
            { id: "b1-lv-11-5", question: "Wie hat sich das Interesse an nachhaltiger Mode ver\u00e4ndert?", options: ["Es ist gesunken", "Es ist gleich geblieben", "Es hat sich stark erh\u00f6ht", "Es ist nur in gro\u00dfen St\u00e4dten gewachsen"], correct: 2, points: 6 },
          ],
        },
        {
          id: "grammatik",
          ...
          text: null,
          questions: [
            { id: "b1-gr-11-1", question: "Welches Wort passt hier? 'Die Modeindustrie geh\u00f6rt zu den gr\u00f6\u00dften ___ der Welt.'", options: ["Umweltverschmutzern", "Umweltverschmutzen", "Umweltverschmutz", "Umweltverschmutzung"], correct: 0, points: 8 },
            { id: "b1-gr-11-2", question: "Wie lautet der korrekte Satz? 'Immer mehr Menschen ___ auf nachhaltige Mode.'", options: ["achtet", "achten", "achtetet", "achtenen"], correct: 1, points: 8 },
            { id: "b1-gr-11-3", question: "Welche Form ist richtig? 'Die Kleidung, die ich kaufe, ___ umweltfreundlich sein.'", options: ["muss", "m\u00fcssen", "mu\u00df", "m\u00fcsse"], correct: 0, points: 8 },
            { id: "b1-gr-11-4", question: "Was ist die richtige Endung? 'Die Designer entwickelten innovative ___.'", options: ["Idee", "Ideen", "Ideen'", "Ideens"], correct: 1, points: 8 },
            { id: "b1-gr-11-5", question: "Wie sagt man es richtig? 'Die L\u00e4den bieten viele ___ Kleidungsst\u00fccke.'", options: ["einzigartig", "einzigartige", "einzigartiges", "einzigartiger"], correct: 1, points: 8 },
          ],
        },
        {
          id: "hoerverstehen",
          ...
          text: null,
          questions: [
            { id: "b1-hv-11-1", question: "Wo leben die Schafe?", options: ["In der Stadt", "In den Alpen", "Am Meer", "In einem Wald"], correct: 1, points: 6 },
            { id: "b1-hv-11-2", question: "Die Schafe helfen dabei, die Landschaft zu pflegen. Wahr oder Falsch?", options: ["Wahr", "Falsch"], correct: 0, points: 6 },
            { id: "b1-hv-11-3", question: "Was machen die Schafe im Winter?", options: ["Sie bleiben auf der Wiese", "Sie ziehen in die St\u00e4lle", "Sie gehen nach Hause", "Sie laufen in den Bergen"], correct: 1, points: 6 },
            { id: "b1-hv-11-4", question: "Die Schafe sind unfreundlich zu den Kindern. Wahr oder Falsch?", options: ["Wahr", "Falsch"], correct: 1, points: 6 },
            { id: "b1-hv-11-5", question: "Die Schafhaltung ist eine neue Tradition im Dorf. Wahr oder Falsch?", options: ["Wahr", "Falsch"], correct: 1, points: 6 },
          ],
        },
      ],
      maxPoints: 100,
    ...
    12: {
      ...
      sections: [
        ...
        },
        {
          ...
          text: null,
          questions: [
            { id: "b1-gr-12-1", question: "Welches Wort ist richtig? \"Die vertikale Farm, ___ in der Stadt steht, ist sehr modern.\"", options: ["A) die", "B) das", "C) der", "D) den"], correct: 0, points: 8 },
        ...
        },
        {
          id: "hoerverstehen",
          title: "Hörverstehen",
          audioSrc: "/audio/aufgabe12/b1.mp3",
          text: null,
          questions: [
            { id: "b1-hv-12-1", question: "Wie hat Technologie unser Leben ver\u00e4ndert?", options: ["A) Wir essen mehr", "B) Wir kommunizieren anders", "C) Wir schlafen weniger", "D) Wir reisen mehr"], correct: 1, points: 6 },
            { id: "b1-hv-12-2", question: "Was ist ein Nachteil der Technologie?", options: ["A) Wir haben mehr Freunde", "B) Wir verbringen weniger Zeit im Gespr\u00e4ch"], correct: 1, points: 6 },
            { id: "b1-hv-12-3", question: "Technologie st\u00e4rkt immer unsere sozialen F\u00e4higkeiten. Wahr oder Falsch?", options: ["Wahr", "Falsch"], correct: 1, points: 6 },
            { id: "b1-hv-12-4", question: "Was sehen einige Menschen in der Technologie?", options: ["A) Nur Nachteile", "B) Eine Bedrohung", "C) Eine Chance", "D) Ein Risiko"], correct: 2, points: 6 },
            { id: "b1-hv-12-5", question: "Technologie hat keinen Einfluss auf unsere Beziehungen. Wahr oder Falsch?", options: ["Wahr", "Falsch"], correct: 1, points: 6 },
          ],
        },
      ],
      maxPoints: 100,
      ...
      sections: [
        {
          ...
          questions: [
            { id: "b2-lv-11-1", question: "Was ist eine m\u00f6gliche negative Folge der Nutzung sozialer Medien?", options: ["A) Erh\u00f6hte Kreativit\u00e4t", "B) Verzerrtes Selbstbild", "C) Bessere Kommunikation", "D) Mehr Freundschaften"], correct: 1, points: 6 },
            { id: "b2-lv-11-2", question: "Was wird als eine Ma\u00dfnahme vorgeschlagen, um mit sozialen Medien umzugehen?", options: ["A) Mehr Zeit in sozialen Medien verbringen", "B) Digitale Pausen einlegen", "C) Alle Informationen ungefiltert konsumieren", "D) Die Nutzung einstellen"], correct: 1, points: 6 },
            { id: "b2-lv-11-3", question: "Welche Plattformen werden im Text erw\u00e4hnt?", options: ["A) LinkedIn und Snapchat", "B) Instagram, Facebook und Twitter", "C) Tumblr und Reddit", "D) YouTube und TikTok"], correct: 1, points: 6 },
            { id: "b2-lv-11-4", question: "Wor\u00fcber wird im Text nicht gesprochen?", options: ["A) Vorteile sozialer Medien", "B) Historische Entwicklung sozialer Medien", "C) Auswirkungen auf die psychische Gesundheit", "D) Informations\u00fcberflutung"], correct: 1, points: 6 },
            { id: "b2-lv-11-5", question: "Welche Art von Studien wird im Text erw\u00e4hnt?", options: ["A) Wirtschaftliche Studien", "B) Psychologische Studien", "C) Soziologische Studien", "D) Technologische Studien"], correct: 1, points: 6 },
          ],
        },
        {
          id: "grammatik",
          ...
          text: null,
          questions: [
            { id: "b2-gr-11-1", question: "Welcher Satz ist grammatikalisch korrekt?", options: ["A) Ich gehe oft ins Kino, weil ich Filme mag.", "B) Ich gehe oft ins Kino weil ich Filme mag.", "C) Ich gehe oft ins Kino, weil ich Filme mag", "D) Ich gehe oft ins Kino weil, ich Filme mag."], correct: 0, points: 8 },
            { id: "b2-gr-11-2", question: "Wie lautet die korrekte Form des Verbs im folgenden Satz? 'Wenn ich mehr Zeit h\u00e4tte, ______ ich mehr B\u00fccher lesen.'", options: ["A) w\u00fcrde", "B) werde", "C) haben", "D) w\u00fcrde haben"], correct: 0, points: 8 },
            { id: "b2-gr-11-3", question: "Welches Wort passt nicht in die Reihe? 'schnell, langsamer, ______, am langsamsten'", options: ["A) schnellster", "B) schneller", "C) schnellste", "D) Schnelligkeit"], correct: 1, points: 8 },
            { id: "b2-gr-11-4", question: "W\u00e4hlen Sie die richtige Pr\u00e4position: 'Er interessiert sich ______ Kunst.'", options: ["A) f\u00fcr", "B) an", "C) in", "D) \u00fcber"], correct: 0, points: 8 },
            { id: "b2-gr-11-5", question: "Was ist der richtige Relativsatz: 'Das ist der Mann, ______ ich gestern getroffen habe.'", options: ["A) den", "B) der", "C) dem", "D) dessen"], correct: 0, points: 8 },
          ],
        },
        {
          id: "hoerverstehen",
          ...
          text: null,
          questions: [
            { id: "b2-hv-11-1", question: "Was ist ein positiver Aspekt sozialer Medien?", options: ["A) Perfekte Online-Pr\u00e4senz", "B) Kontakt zu Freunden und Familie", "C) Druck und Stress", "D) Psychische Gesundheitsprobleme"], correct: 1, points: 6 },
            { id: "b2-hv-11-2", question: "Soziale Medien haben keine negativen Aspekte. ", options: ["Wahr", "Falsch"], correct: 1, points: 6 },
      ...
      sections: [
        {
          ...
          questions: [
            ...
            { id: "b2-lv-12-2", question: "Welches Konzept wird mit Minimalismus verbunden?", options: ["A) \u00dcberfluss", "B) Freiheit", "C) Komplexit\u00e4t", "D) Stress"], correct: 1, points: 6 },
        ...
        },
        {
          ...
          questions: [
            ...
            { id: "b2-gr-12-4", question: "Welche Pr\u00e4position passt hier richtig: Er interessiert sich ______ Kunst.", options: ["A) f\u00fcr", "B) an", "C) mit", "D) \u00fcber"], correct: 0, points: 8 },
        ...
        },
        {
          id: "hoerverstehen",
          title: "Hörverstehen",
          audioSrc: "/audio/aufgabe12/b2.mp3",
          text: null,
          questions: [
            { id: "b2-hv-12-1", question: "Was ist Minimalismus?", options: ["A) Ein Lebensstil", "B) Eine Di\u00e4t", "C) Eine Sportart", "D) Eine Kunstform"], correct: 0, points: 6 },
            { id: "b2-hv-12-2", question: "Welches Ziel verfolgt Minimalismus?", options: ["A) Mehr Geld verdienen", "B) \u00dcberfl\u00fcssige Dinge loswerden"], correct: 1, points: 6 },
            { id: "b2-hv-12-3", question: "Minimalismus f\u00f6rdert nur materielle Zufriedenheit. (Wahr/Falsch)?", options: ["Wahr", "Falsch"], correct: 1, points: 6 },
            { id: "b2-hv-12-4", question: "Welche Aspekte sind laut dem Text wichtig im Minimalismus?", options: ["A) Beziehungen", "B) Konsum", "C) Materieller Besitz", "D) Reisen"], correct: 0, points: 6 },
            { id: "b2-hv-12-5", question: "Minimalismus f\u00fchrt zu einem \u00dcberma\u00df an Stress. (Wahr/Falsch)?", options: ["Wahr", "Falsch"], correct: 1, points: 6 },
          ],
        },
      ],
      maxPoints: 100,
