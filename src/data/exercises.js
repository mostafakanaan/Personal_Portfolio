      ...
      sections: [
        {
          ...
          questions: [
            { id: "b2-lv-15-1", question: "Was ist ein zentraler Grund für die Entstehung von Mythologien?", options: ["Um gesellschaftliche Normen abzubilden", "Um historische Ereignisse festzuhalten", "Um persönliche Geschichten zu erzählen", "Um wissenschaftliche Phänomene zu erklären"], correct: 0, points: 10 },
            { id: "b2-lv-15-2", question: "Was vermittelt die Mythologie laut dem Text?", options: ["Politische Ansichten", "Moralische und ethische Werte", "Wirtschaftliche Strategien", "Technische Innovationen"], correct: 1, points: 10 },
            { id: "b2-lv-15-3", question: "Was spiegelt die Mythologie wider?", options: ["Die Naturgesetze", "Die gesellschaftlichen Normen und Ängste", "Die wirtschaftlichen Bedingungen", "Die geografischen Gegebenheiten"], correct: 1, points: 10 },
            { id: "b2-lv-15-4", question: "Was ermöglicht die Analyse von Mythologien?", options: ["Das Verstehen der Geschichte", "Die Entwicklung wissenschaftlicher Konzepte", "Die Vorhersage künftiger Ereignisse", "Die Schaffung neuer Mythen"], correct: 0, points: 10 },
            { id: "b2-lv-15-5", question: "Wie wird die menschliche Psyche in Bezug auf Mythologien beschrieben?", options: ["Als uninteressant", "Als komplex und tiefgehend", "Als einfach und klar", "Als unveränderlich"], correct: 1, points: 10 },
          ],
        },
        {
          id: "hoerverstehen",
          title: "Hörverstehen",
          text: "Eine kurze Radiostimme erklärt, dass Menschen Mythen oft nicht nur zur Unterhaltung, sondern auch zur Orientierung nutzen. In der Aufnahme wird gesagt, dass Geschichten über Götter, Helden und Naturereignisse helfen können, Ängste zu ordnen und Werte weiterzugeben. Danach erwähnt die Sprecherin, dass Forschende Mythen als Fenster in das Denken früherer Gesellschaften sehen. Zum Schluss lädt sie dazu ein, beim nächsten Museumsbesuch bewusst auf die Sprache der Erzählungen zu achten.",
          questions: [
            { id: "b2-hv-15-1", question: "Wozu nutzen Menschen Mythen laut der Aufnahme oft?", options: ["Nur zur Unterhaltung", "Zur Orientierung", "Zum Sport", "Zum Kochen"], correct: 1, points: 10 },
            { id: "b2-hv-15-2", question: "Welche Figuren werden genannt?", options: ["Könige und Händler", "Götter, Helden und Naturereignisse", "Ärzte und Lehrer", "Polizisten und Richter"], correct: 1, points: 10 },
            { id: "b2-hv-15-3", question: "Was können Geschichten laut Aufnahme helfen?", options: ["Ängste ordnen und Werte weitergeben", "Züge pünktlicher machen", "Wetter vorhersagen", "Preise senken"], correct: 0, points: 10 },
            { id: "b2-hv-15-4", question: "Wie sehen Forschende Mythen?", options: ["Als Ersatz für Bücher", "Als Fenster in das Denken früherer Gesellschaften", "Als moderne Technik", "Als Zufall"], correct: 1, points: 10 },
            { id: "b2-hv-15-5", question: "Worauf soll man beim Museumsbesuch achten?", options: ["Auf die Farben", "Auf die Sprache der Erzählungen", "Auf die Preise", "Auf die Kleidung der Besucher"], correct: 1, points: 10 },
          ],
        },
        {
          id: "grammatik",
          ...
          text: null,
          questions: [
            { id: "b2-gr-15-1", question: "Welcher Satz ist grammatikalisch korrekt?", options: ["Er sagte, dass er morgen kommt.", "Er hat gesagt, dass er morgen kommt.", "Er hat gesagt, dass er morgen kam.", "Er sagte, dass er morgen kam."], correct: 0, points: 10 },
            { id: "b2-gr-15-2", question: "Welche Form des Verbs ist hier korrekt?", options: ["Ich kann, dass ich es tue.", "Ich kann, dass ich es tun.", "Ich kann, dass ich es tat.", "Ich kann, dass ich es getan habe."], correct: 1, points: 10 },
            { id: "b2-gr-15-3", question: "Wählen Sie die richtige Präposition:", options: ["Ich interessiere mich für Kunst.", "Ich interessiere mich an Kunst.", "Ich interessiere mich in Kunst.", "Ich interessiere mich mit Kunst."], correct: 0, points: 10 },
            { id: "b2-gr-15-4", question: "Welcher Satz ist im Konjunktiv I korrekt?", options: ["Er sagt, dass er morgen kommt.", "Er sagte, dass er morgen komme.", "Er sagt, dass er morgen kam.", "Er sagte, dass er morgen kommt."], correct: 1, points: 10 },
            { id: "b2-gr-15-5", question: "Welche Form ist im Passiv korrekt?", options: ["Das Buch wurde von ihm geschrieben.", "Das Buch ist von ihm geschrieben worden.", "Das Buch wurde geschrieben von ihm.", "Das Buch war geschrieben von ihm."], correct: 0, points: 10 },
          ],
        },
        {
          id: "spiel",
          ...
          text: null,
          questions: [
            { id: "b2-sp-15-1", question: "Welche Idee passt am besten zu Mythologien?", options: ["Nur Fakten", "Geschichten mit Symbolen", "Sportregeln", "Einkaufslisten"], correct: 1, points: 10 },
            { id: "b2-sp-15-2", question: "Was ist ein typisches Wort für eine Erzählfigur?", options: ["Helden", "Kartoffel", "Fenster", "Stift"], correct: 0, points: 10 },
            { id: "b2-sp-15-3", question: "Was passt nicht zum Thema Mythologie?", options: ["Götter", "Sagen", "Legenden", "Büroklammern"], correct: 3, points: 10 },
            { id: "b2-sp-15-4", question: "Wofür steht das Spiel hier am ehesten?", options: ["Wortschatz", "Musik", "Mathe", "Sport"], correct: 0, points: 10 },
            { id: "b2-sp-15-5", question: "Wie viele neue Abschnitte hat Aufgabe 15 jetzt?", options: ["Einer", "Zwei", "Drei", "Vier"], correct: 1, points: 10 },
          ],
        },
      ],
      maxPoints: 200,
